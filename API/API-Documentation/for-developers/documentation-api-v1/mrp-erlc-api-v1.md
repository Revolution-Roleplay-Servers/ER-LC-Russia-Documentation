...
{% hint style="danger" %}
**Эндпоинты `/v1/moscowroleplay/erlc/server/*` больше не поддерживаются и не работают. Исключением является только эндпоинт `/v1/moscowroleplay/erlc/server/bans`, так как он отсутствует в версии v2.**\
\
**Для всех остальных задач, пожалуйста, переходите на версию v2, подробнее** [mrp-erlc-api-v2](../documentation-api-v2/mrp-erlc-api-v2/ "mention")**.**
{% endhint %}
...
[OpenAPI erlc-russia-server-api](https://4401d86825a13bf607936cc3a9f3897a.r2.cloudflarestorage.com/gitbook-x-prod-openapi/raw/8c681394488584d2cb024017a0c253a2fda0000a5bd6c654f004b31f00007bc2.yaml?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=dce48141f43c0191a2ad043a6888781c%2F20260506%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20260506T091438Z&X-Amz-Expires=172800&X-Amz-Signature=a3bb5a7b64af9da2161cf3ab8f1c58d643bff6d03da5198ed8a021ca681f6732&X-Amz-SignedHeaders=host&x-amz-checksum-mode=ENABLED&x-id=GetObject)
