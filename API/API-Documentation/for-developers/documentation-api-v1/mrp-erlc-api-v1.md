...
{% hint style="danger" %}
**Эндпоинты `/v1/moscowroleplay/erlc/server/*` больше не поддерживаются и не работают. Исключением является только эндпоинт `/v1/server/bans`, так как он отсутствует в версии v2.**\
\
